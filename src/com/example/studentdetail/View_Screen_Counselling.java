...
public class View_Screen_Counselling extends Activity{
	
	TextView tv1, tv2, tv3, tv4, tv5,tv6,tv7;
	String fname, lname,  rollno, mobile, year,details,edittext, desig, home,email;
	String result = null;
	InputStream is = null;
    ...
    private class AsyncTaskRunner extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				HttpPost post = new HttpPost(
						"http://abhirkmv.hostei.com/counselling.php");
		...
		ProgressDialog dialog = new ProgressDialog(View_Screen_Counselling.this);
		...
		protected void onPostExecute(String result) {
			...
			tv4.setText("Batch: "+" "+" "+" "+" "+" "+" "+" "+" " +year +" " +"year");
			tv5.setText("Mobile No.: "+" " +" "+ mobile);
			tv6.setText("Email Id: "+" "+" "+" " +" " +" "+ email);
			tv7.setText("Home Town: "+" " +" " + home);
