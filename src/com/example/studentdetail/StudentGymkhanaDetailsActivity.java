...
public class StudentGymkhanaDetailsActivity extends Activity implements OnItemSelectedListener{
    
	Button button;
	ListView listView;
	String item;
	
	String fname, lname, rollno, branch, mobile, year,desig, por_in;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_gymkhana_layout);
        ...
        categories.add("Senators");
        categories.add("General_Executive");
        categories.add("Joint_General_EXecutive");
        categories.add("Financial_Conveynor");
        categories.add("Coordinator_in_NUTS");
        categories.add("Coordinator_in_MAD");
        categories.add("Coordinator_in_WAVES");
        categories.add("HMC");
        categories.add("MMC");
		...
		button.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				// true or false
				{
					...
					showAlertDialog(StudentGymkhanaDetailsActivity.this,
	...
	private class AsyncTaskRunner extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				HttpPost post = new HttpPost("http://abhirkmv.hostei.com/gymkhana.php");
		...
		ProgressDialog dialog = new ProgressDialog(StudentGymkhanaDetailsActivity.this);
		...
		protected void onPostExecute(String result) {
			...
			ArrayAdapter<String> adapter = new ArrayAdapter<String>(
					StudentGymkhanaDetailsActivity.this,
