...
public class View_Screen extends Activity{
	
	TextView tv1, tv2, tv3, tv4, tv5,tv6;
	String fname, lname,  rollno, branch, mobile, year,details,edittext;
	String result = null;
	InputStream is = null;
    ...
    private class AsyncTaskRunner extends AsyncTask<String, String, String> {
		...
		ProgressDialog dialog = new ProgressDialog(View_Screen.this);
		...
		protected void onPostExecute(String result) {
			...
			tv4.setText("Year: " +" "+" "+" "+" "+" "+" "+" "+" "+" "+" "+year);
			tv5.setText("Discipline: "+" "+" "+" " + branch);
			tv6.setText("Mobile No.: "+" "+" " + mobile);
		}
